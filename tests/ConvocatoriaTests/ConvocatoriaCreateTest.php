...
use tests\creacionDatos;

class ConvocatoriaCreateTest extends TestCase
{    
     ...
     * @return void
     */
    public function testCreateConvocatoria()
    {
        $convocatoriaData = $this->creacionDatosConvocatoria();
        ...
        $response = $this->call('POST','/convocatoria/create', $convocatoriaData, [], [], ['HTTP_Authorization' => 'Bearer ' . $token]);        
     ...
     * @return void
     */
    public function testBadCreateConvocatoria()
    {
        $convocatoriaData = $this->creacionDatosConvocatoria();
        // Separamos el TOKEN para validar el acceso del admin
        $token = $this->getToken('admin','admin');
        // Enviamos una solicitud de registro con datos incorrectos
        $response = $this->call('POST','/convocatoria/create', $convocatoriaData, [], [], ['HTTP_Authorization' => $token]);        
     ...
     * @return void
     */
    public function testBadCreateConvocatoriaValidation()
    {
        $response = $this->testBadCreateConvocatoria();
     ...
     * @return void
     */
    public function testCannotDuplicateCreateConvocatoriaData()
    {
        // Separamos el TOKEN para validar el acceso del admin
        $token = $this->getToken('admin','admin');
        $convocatoriaData = $this->creacionDatosConvocatoria();       
